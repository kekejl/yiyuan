...
public class UmengMessageActivity extends BaseActivity {
    ...
    protected void init(Bundle savedInstanceState) {
         Log.d("umeng接收的数据",getIntent().getStringExtra("umeng"+""));
        ...
        //加载需要显示的网页
        //设置Web视图
        webView.setWebViewClient(new UmengMessageActivity.webViewClient());
    ...
    protected void onResume() {
        ...
        Log.d("友盟自定义参数222", listcustom.toString());
