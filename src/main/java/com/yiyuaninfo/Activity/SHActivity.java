...
public class SHActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{ "美食", "健康", "家居", "购物", "丽人", "汽车", "旅游", "情感" };
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        colorTrackTabLayout = (ColorTrackTabLayout) findViewById(R.id.ColorTrackTabLayout_sh);
        viewPager = (ViewPager) findViewById(R.id.view_pager_sh);
