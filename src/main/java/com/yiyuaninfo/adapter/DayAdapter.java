...
import com.yiyuaninfo.util.ViewUtil;
...
public class DayAdapter extends RecyclerView.Adapter<DayAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        switch (week) {
            case 0:
                holder.tvWeek.setText("周日");
                break;
            case 1:
                holder.tvWeek.setText("周一");
                break;
            case 2:
                holder.tvWeek.setText("周二");
                break;
            case 3:
                holder.tvWeek.setText("周三");
                break;
            case 4:
                holder.tvWeek.setText("周四");
                break;
            case 5:
                holder.tvWeek.setText("周五");
                break;
            case 6:
                holder.tvWeek.setText("周六");
                break;
        }
        holder.tvWeek.setTextColor(Color.parseColor("#000000"));
        int  day=datas.get(position).getDay();
        int   month=datas.get(position).getMonth();
        if(day== DateUtil.getCurrentDay()&&month==DateUtil.getCurrentMonth()){
            holder.tvWeek.setText("今天");
            holder.tvWeek.setTextColor(Color.parseColor("#d43c33"));
        }
