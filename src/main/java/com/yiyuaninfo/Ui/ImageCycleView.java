...
import com.yiyuaninfo.ScaleInTransformer;
import com.yiyuaninfo.entity.ADInfo;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 图片轮播视图
	 */
	private CycleViewPager1 mBannerPager = null;
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		mBannerPager = (CycleViewPager1) findViewById(R.id.pager_banner);
		mBannerPager.setPageMargin(20);
	...
	public void setImageResources(ArrayList<ADInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
		...
		mBannerPager.setPageTransformer(true, new ScaleInTransformer());
		startImageTimerTask();
	}
